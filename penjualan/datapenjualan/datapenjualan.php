...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="../asset/dist/img/Penjualan1-128x128.jpg" alt="Penjualan Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="../asset/dist/img/Penjualan8-128x128.jpg" alt="Penjualan Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="../asset/dist/img/Penjualan3-128x128.jpg" alt="Penjualan Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-Penjualans mr-2"></i> 8 friend requests
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- Sidebar -->
    <div class="sidebar">
      <!-- Sidebar Penjualan panel (optional) -->
      <div class="Penjualan-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../../asset/dist/img/Penjualan2-160x160.jpg" class="img-circle elevation-2" alt="Penjualan Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="dataPenjualan.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-6 col-md-3 mt-2">
      <input type="text" class="form-control" id="nmbahan" placeholder="Nama Bahan">
    </div>
     </div>
        <div class="row">
...
<?php include('part/footer.php'); ?>
    <script type="text/javascript">
      ...
      $(document).on('change','#kategori,#harga_awal,#harga_akhir',function(e)
      {
       ...
       $(document).on('keyup','#nama,#nmbahan',function(e)
      {
        setTimeout(function(){
          getData(1); },
          1000);
       ...
       function getData(page=1)
       {
        ...
        let nmproduk = $("#nama").val();
        let jml = $("#jmlPenjualan").val();
        let harga_awal= $("#harga_awal").val();
        let harga_akhir= $("#harga_akhir").val();
        let tglPenjualan = $("#tglPenjualan").val();
        let satuan = $("#satuan").val();
        let namaBBK = $("#nmbahan").val();
        ...
        $.ajax({
          ...
          success : function(xhr)
          {
            ...
            if (xhr.data.length>0) {
              ...
              {
                result += `<tr><td>${no++}</td><td>${i.nama}</td><td>${i.nmbahan}</td><td>${i.kategori}</td><td>${i.stok}</td><td>${i.harga}</td><td>${i.satuan}</td><td>
            
<a href="#" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#updatedata${i.idproduk}"><svg class="bi bi-pencil" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M11.293 1.293a1 1 0 011.414 0l2 2a1 1 0 010 1.414l-9 9a1 1 0 01-.39.242l-3 1a1 1 0 01-1.266-1.265l1-3a1 1 0 01.242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z" clip-rule="evenodd"/>
                <path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 00.5.5H4v.5a.5.5 0 00.5.5H5v.5a.5.5 0 00.5.5H6v-1.5a.5.5 0 00-.5-.5H5v-.5a.5.5 0 00-.5-.5H3z" clip-rule="evenodd"/>
                </svg></i></a>
        <a class="btn btn-danger btn-sm " data-toggle="modal" data-target="#deletedata${i.idp}"><svg class="bi bi-trash" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path d="M5.5 5.5A.5.5 0 016 6v6a.5.5 0 01-1 0V6a.5.5 0 01.5-.5zm2.5 0a.5.5 0 01.5.5v6a.5.5 0 01-1 0V6a.5.5 0 01.5-.5zm3 .5a.5.5 0 00-1 0v6a.5.5 0 001 0V6z"/>
  <path fill-rule="evenodd" d="M14.5 3a1 1 0 01-1 1H13v9a2 2 0 01-2 2H5a2 2 0 01-2-2V4h-.5a1 1 0 01-1-1V2a1 1 0 011-1H6a1 1 0 011-1h2a1 1 0 011 1h3.5a1 1 0 011 1v1zM4.118 4L4 4.059V13a1 1 0 001 1h6a1 1 0 001-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" clip-rule="evenodd"/>
</svg></a>        
                <div class="modal fade" id="deletedata${i.idproduk}" tabindex="-1" role="dialog"  aria-hidden="true">
       ...
       <div class="modal-header">
        <h5 class="modal-title" >Hapus Data</h5>
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="CRUD/hapus.php?id=${i.idproduk}" class="btn btn-primary">Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
<div class="modal fade" id="updatedata${i.idproduk}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel${i.idproduk}" aria-hidden="true">
 <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
...
<input type="hidden" class="form-control" name="idproduk" value="${i.idproduk}">
