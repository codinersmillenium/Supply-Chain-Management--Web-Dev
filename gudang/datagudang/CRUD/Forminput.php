...
<?php  mysql_connect("localhost","root","") or die(mysql_error());
      ...
      $query = mysql_query("SELECT * from bahanbaku,user where bahanbaku.idsupplier=user.iduser and user.idrole='7'");
      ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="Forminput.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Bahan Baku Masuk</h1><h4><a href="#" data-toggle="modal" data-target="#tambahdata">Tambah Supplier</a></h4>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
         ...
         <select class="form-control" name="role">
           <option value="">Bahan Baku -- Supplier</option>
           <?php while ( $row= mysql_fetch_array($query)) {
             # code... ?>
             <option value="<?php echo $row['idbbk'] ?>"><?php echo $row['namaBBK'] ?> -- <?php echo $row['nama'] ?></option>
             <?php 
             } ?>
         </select>
       </div>
